...
export default function BentoGrid() {
  ...
  return (
    ...
    >
      ...
      {/* BENTO GRID MATRIX */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-7xl w-full mx-auto">
        
        {/* Card 1: Full-Stack Engineering */}
        <article className="bento-card md:col-span-2 h-auto md:h-[45vh] bg-zinc-950 border border-zinc-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between items-center md:items-stretch text-center md:text-left gap-6 md:gap-0 transition-colors duration-300 hover:border-zinc-800">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-1.5 md:gap-2 pt-4 border-t border-zinc-900 w-full">
        ...
        {/* Card 2: UI & Motion */}
        <article className="bento-card h-auto md:h-[45vh] bg-zinc-950 border border-zinc-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between items-center md:items-stretch text-center md:text-left gap-6 md:gap-0 transition-colors duration-300 hover:border-zinc-800">
          <header className="flex flex-col items-center md:items-start w-full">
          ...
          <p className="text-xs md:text-sm text-zinc-400 font-sans leading-relaxed font-light md:mb-4">
          ...
          <footer className="font-mono text-[9px] md:text-[10px] text-zinc-500 tracking-wider border-t border-zinc-900 pt-4 w-full">
            [ GSAP / Three.js / Locomotive ]
          </footer>
        </article>

        {/* Card 3: Mobile Engineering */}
        <article className="bento-card h-auto md:h-[40vh] bg-zinc-950 border border-zinc-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between items-center md:items-stretch text-center md:text-left gap-6 md:gap-0 transition-colors duration-300 hover:border-zinc-800">
          <header className="flex flex-col items-center md:items-start">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-zinc-900 w-full">
        ...
        {/* Card 4: Architecture */}
        <article className="bento-card md:col-span-2 h-auto md:h-[40vh] bg-zinc-950 border border-zinc-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between items-center md:items-stretch text-center md:text-left gap-6 md:gap-0 transition-colors duration-300 hover:border-zinc-800">
          <header className="flex flex-col items-center md:items-start">
          ...
          <footer className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0 w-full pt-4 border-t border-zinc-900 font-mono text-[9px] md:text-[10px] text-zinc-500">
