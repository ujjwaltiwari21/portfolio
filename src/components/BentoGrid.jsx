...
export default function BentoGrid() {
  ...
  return (
    <section 
      ref={containerRef} 
      className="min-h-screen bg-[#060709] text-white py-24 px-4 sm:px-6 md:px-16 flex flex-col justify-center relative overflow-hidden font-mono antialiased"
    ...
    >
      ...
      <div className="mb-12 md:mb-16 max-w-4xl border-t-2 md:border-t-0 md:border-l-2 border-emerald-500 pt-6 md:pt-0 md:pl-6 text-center md:text-left mx-auto md:mx-0 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-7xl w-full mx-auto relative z-10 [perspective:1200px]">
        
        {/* Card 1: Full-Stack Engineering */}
        <article 
          onMouseMove={(e) => handleMouseMove(e, e.currentTarget)}
          onMouseLeave={(e) => handleMouseLeave(e.currentTarget)}
          className="bento-card md:col-span-2 h-auto md:h-[45vh] bg-[#0c0d12] border border-zinc-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between items-center md:items-stretch text-center md:text-left gap-6 md:gap-0 [transform-style:preserve-3d] will-change-transform transition-colors duration-300 hover:border-emerald-500/30"
        >
          <header className="flex flex-col items-center md:items-start [transform:translateZ(18px)] transition-transform duration-300">
            ...
            <p className="text-xs md:text-sm text-zinc-400 mt-2 max-w-xl font-light font-sans">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-1.5 md:gap-2 pt-4 border-t border-zinc-900 w-full [transform:translateZ(12px)] transition-transform duration-300">
            {['Next.js 15', 'React', 'Node.js', 'TypeScript', 'Tailwind CSS', 'RESTful APIs'].map((tech, i) => (
              <span key={i} className="px-2.5 py-1 md:px-3 md:py-1.5 bg-zinc-950 border border-zinc-900 rounded-lg text-[10px] md:text-[11px] font-mono text-zinc-400 font-bold">
                {tech}
              </span>
            ))}
          </div>
        ...
        >
          ...
          <p className="text-xs md:text-sm text-zinc-400 font-sans leading-relaxed font-light md:mb-4 [transform:translateZ(15px)] transition-transform duration-300">
          ...
          <footer className="font-mono text-[9px] md:text-[10px] text-zinc-500 tracking-wider border-t border-zinc-900 pt-4 w-full [transform:translateZ(10px)] transition-transform duration-300">
        ...
        <article 
          onMouseMove={(e) => handleMouseMove(e, e.currentTarget)}
          onMouseLeave={(e) => handleMouseLeave(e.currentTarget)}
          className="bento-card h-auto md:h-[40vh] bg-[#0c0d12] border border-zinc-900 rounded-2xl p-6 md:p-8 flex flex-col justify-between items-center md:items-stretch text-center md:text-left gap-6 md:gap-0 [transform-style:preserve-3d] will-change-transform transition-colors duration-300 hover:border-emerald-500/30"
        >
          <header className="flex flex-col items-center md:items-start [transform:translateZ(18px)] transition-transform duration-300">
          ...
          <p className="text-xs text-zinc-400 font-sans font-light [transform:translateZ(12px)] transition-transform duration-300">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-zinc-900 w-full [transform:translateZ(15px)] transition-transform duration-300">
            ...
            <div className="w-7 h-7 rounded-full border border-zinc-800 flex items-center justify-center text-zinc-400 font-mono text-[9px] bg-zinc-950 font-bold">
              iOS
            </div>
          </div>
        </article>
        ...
        >
          ...
          <p className="text-xs md:text-sm text-zinc-400 font-sans max-w-xl font-light [transform:translateZ(12px)] transition-transform duration-300">
          ...
          <footer className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0 w-full pt-4 border-t border-zinc-900 font-mono text-[9px] md:text-[10px] text-zinc-500 [transform:translateZ(10px)] transition-transform duration-300">
